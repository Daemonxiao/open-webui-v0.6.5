...
PROD_USAGE_RECONCILE_LOCAL_USERNAME_FILTER="${PROD_USAGE_RECONCILE_LOCAL_USERNAME_FILTER:-admin}"
PROD_USAGE_RECONCILE_USERNAME_MAP="${PROD_USAGE_RECONCILE_USERNAME_MAP:-Sparkline:admin}"
...
main() {
  ...
  set_var PROD_USAGE_RECONCILE_LOCAL_USERNAME_FILTER "$PROD_USAGE_RECONCILE_LOCAL_USERNAME_FILTER"
  set_var PROD_USAGE_RECONCILE_USERNAME_MAP "$PROD_USAGE_RECONCILE_USERNAME_MAP"
